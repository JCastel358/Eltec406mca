...
Examples (run from the repo root):
  ...
  python engineer_tools/noise_band/replot_noise_capture.py                # all 405 captures, default bands
  python engineer_tools/noise_band/replot_noise_capture.py --band 0.5 2 --band 0.3 5
  python engineer_tools/noise_band/replot_noise_capture.py <dir-or-file> --show
  python engineer_tools/noise_band/replot_noise_capture.py --model 40623 --position 2-4   # one array position, all trays
"""
