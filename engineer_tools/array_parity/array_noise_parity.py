...
Examples (from the repository root):
  ...
  python engineer_tools/array_parity/array_noise_parity.py --legacy legacy_readings.csv --array "%USERPROFILE%/Documents/Eltec_40623_Test_Results/40623_array_daq/40623_array_lot_12.csv"
  python engineer_tools/array_parity/array_noise_parity.py --legacy legacy_readings.csv --array <dir with tray_*_raw.npz> --replay-band 0.5 5 --replay-band 0.3 10
"""
...
def fft_band_filter(waveform_v: np.ndarray, rate_hz: float, low_hz: float | None, high_hz: float | None, order: int = 4) -> np.ndarray:
    """Zero-phase Butterworth-magnitude band filter via FFT (as engineer_tools/noise_band/replot_noise_capture.py)."""
