...
Examples (run from the repo root):
  ...
  python engineer_tools/emitter/emitter_waveform_comparison.py capture --setup legacy --label det42 --seconds 30

  # same detector on the rig fixture, 18 Hz 20/80, 10 s emitter warm-up
  python engineer_tools/emitter/emitter_waveform_comparison.py capture --setup rig --freq 18 --label det42 --seconds 30
  ...
  python engineer_tools/emitter/emitter_waveform_comparison.py compare --show
"""
