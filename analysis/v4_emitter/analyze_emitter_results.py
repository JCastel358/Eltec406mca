"""
Analyze 406MCA emitter-rig (v4) production data.

Default run:
    python analyze_emitter_results.py

The script reads every 406mca_emitter_lot_*.csv file in the v3 results folder
(Documents\\Eltec_406MCA_Test_Results\\v4_emitter), summarizes pass/fail yield,
...
# --------------------------------------------------------------------------- #
DEFAULT_RESULTS_DIR = (
    Path.home() / "Documents" / "Eltec_406MCA_Test_Results" / "v4_emitter"
)
...
<body>
<header>
<h1>406MCA Emitter Rig (v4) Data Analysis</h1>
