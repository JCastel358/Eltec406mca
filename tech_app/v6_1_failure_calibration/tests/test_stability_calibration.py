...
from tech_app.v6_1_failure_calibration import esp32_backend as backend
from tech_app.v6_1_failure_calibration import stability_calibration as calibration
from tech_app.v6_1_failure_calibration.stability_analysis import StabilitySettings
...
class ParserTests(unittest.TestCase):
    def test_capture_parser_exposes_requested_interface_and_defaults(self):
        ...
        self.assertEqual(
            calibration.DEFAULT_OUTPUT_DIR.parent.name,
