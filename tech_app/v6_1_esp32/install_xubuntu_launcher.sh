#!/usr/bin/env bash
# Install v6.1 XFCE desktop and per-user Applications-menu launchers.
...
ENTRY_NAME='com.eltec.406mca-esp32-tester-v6-1.desktop'
...
DESKTOP_ENTRY="$DESKTOP_DIR/Eltec 406MCA ESP32 Tester v6.1.desktop"
...
TMP_ENTRY=$(mktemp "${TMPDIR:-/tmp}/eltec-406mca-v6-1-launcher.XXXXXX.desktop")
...
printf 'Installed the Eltec 406MCA ESP32 Tester v6.1 launcher:\n'
