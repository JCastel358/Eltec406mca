#!/usr/bin/env bash
# Install 405 M22 XFCE desktop and per-user Applications-menu launchers.
...
LAUNCHER="$SCRIPT_DIR/run_eltec_405m22_esp32_tester.sh"
APP_PATH="$SCRIPT_DIR/eltec_405m22_esp32_tester.py"
ICON_PATH="$SCRIPT_DIR/assets/eltec_desktop_icon.png"
ENTRY_NAME='com.eltec.405m22-esp32-tester.desktop'
...
DESKTOP_ENTRY="$DESKTOP_DIR/Eltec 405 M22 ESP32 Tester.desktop"
...
TMP_ENTRY=$(mktemp "${TMPDIR:-/tmp}/eltec-405m22-launcher.XXXXXX.desktop")
...
printf 'Installed the Eltec 405 M22 ESP32 Tester launcher:\n'
