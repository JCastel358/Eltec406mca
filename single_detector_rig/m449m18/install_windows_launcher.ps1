<#
.SYNOPSIS
    Install Desktop and Start Menu shortcuts for the Eltec 449 M18 ESP32 Tester.
...
.DESCRIPTION
    ...
    run_eltec_449m18_esp32_tester.cmd in this folder, so moving or updating the
...
$Launcher = Join-Path $ScriptDir 'run_eltec_449m18_esp32_tester.cmd'
$AppPath = Join-Path $ScriptDir 'eltec_449m18_esp32_tester.py'
...
$DisplayName = 'Eltec 449 M18 ESP32 Tester'
...
try {
    foreach ($link in @($DesktopLink, $StartMenuLink)) {
        ...
        $shortcut.Description = 'Eltec Model 449 M18 (5/18 Hz) pyroelectric detector tester - ESP32/ADS1256 rig'
...
""
"Launcher : $Launcher"
"Log file : $env:LOCALAPPDATA\eltec-449m18-esp32\launcher.log"
"Results  : $([Environment]::GetFolderPath('MyDocuments'))\Eltec_449M18_Test_Results\449m18_esp32"
