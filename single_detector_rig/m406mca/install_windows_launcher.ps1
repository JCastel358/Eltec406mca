<#
.SYNOPSIS
    Install Desktop and Start Menu shortcuts for the Eltec 406MCA ESP32 Tester v6.1.
...
.DESCRIPTION
    ...
    run_eltec_406mca_esp32_tester.cmd in this folder, so moving or updating the
...
$Launcher = Join-Path $ScriptDir 'run_eltec_406mca_esp32_tester.cmd'
$AppPath = Join-Path $ScriptDir 'eltec_406mca_esp32_tester.py'
...
$DisplayName = 'Eltec 406MCA ESP32 Tester v6.1'
...
try {
    foreach ($link in @($DesktopLink, $StartMenuLink)) {
        ...
        $shortcut.Description = 'Eltec Model 406 MCA (10 Hz) pyroelectric detector tester - ESP32/ADS1256 rig'
...
""
"Launcher : $Launcher"
"Log file : $env:LOCALAPPDATA\eltec-406mca-esp32-v6-1\launcher.log"
"Results  : $([Environment]::GetFolderPath('MyDocuments'))\Eltec_406MCA_Test_Results\v6_1_esp32"
