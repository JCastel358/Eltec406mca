...
- **Legacy standalone 406MCA rigs running `tech_app/v6_esp32` or
  `tech_app/v6_1_esp32`: v1.9.** Those apps never send `FE` commands, so on a
...
- **Legacy standalone 405 M22 rig running `tech_app/405m22_esp32`: v2.0
